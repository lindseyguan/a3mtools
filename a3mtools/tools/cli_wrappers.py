...
def colabfold_batch_wrapper(
    ...
    colab_command = f"{colabfold_executable} --model-type alphafold2_ptm --amber --num-relax 5 --use-gpu-relax --data '{colabfold_data}' --pair-mode unpaired {input_file} {output_dir}"
